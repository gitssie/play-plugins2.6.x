...
import play.api.deadbolt.session.{InvalidSessionException, Session}
...
/**
  ...
  * @since 1.0
  */
trait NativeSessionManager extends SessionManager {
  /**
    ...
    */
    def getStartTimestamp(key: SessionKey): Date
  ...
  /**
    ...
    */
  def getLastAccessTime(key: SessionKey): Date
  ...
  /**
    ...
    */
  def isValid(key: SessionKey): Boolean
  ...
  def checkValid(key: SessionKey): Unit
  ...
  /**
    ...
    */
  @throws[InvalidSessionException]
  def getTimeout(key: SessionKey): Long
  ...
  /**
    ...
    */
  @throws[InvalidSessionException]
  def setTimeout(key: SessionKey, maxIdleTimeInMillis: Long): Unit
  ...
  /**
    ...
    *
    * @param session the session key to use to look up the target session.
    * if the session has been stopped or expired prior to calling this method.
    * @see org.apache.shiro.session.Session#touch
    */
  @throws[InvalidSessionException]
  ...
  /**
    ...
    */
  def getHost(key: SessionKey): String
  ...
  /**
    ...
    */
  def getAttributeKeys(sessionKey: SessionKey): util.Collection[String]
  ...
  /**
    ...
    */
  @throws[InvalidSessionException]
  def getAttribute(sessionKey: SessionKey, attributeKey: String): AnyRef
  ...
  /**
    ...
    */
  @throws[InvalidSessionException]
  def setAttribute(sessionKey: SessionKey, attributeKey: String, value: AnyRef): Unit
  ...
  /**
    ...
    */
  @throws[InvalidSessionException]
  def removeAttribute(sessionKey: SessionKey, attributeKey: String): AnyRef
}