...
class  MapSession(val attributes:java.util.Map[String,String]) extends Session{
  ...
  private var timeout: Long = Int.MinValue
  ...
  /**
    ...
    * @since 0.2
    */
  override def setTimeout(maxIdleTimeInMillis: Long): Unit = this.timeout = timeout
  ...
  /**
    ...
    */
  override def getHost: String = this.host
  ...
  override def getAttributeKeys: util.Collection[String] = attributes.keySet()
  ...
  /**
    ...
    *                                 this method.
    */
  override def getAttribute(key: String): AnyRef = attributes.get(key)
  ...
  /**
    ...
    *                                 this method.
    */
  override def setAttribute(key: String, value: AnyRef): Unit = attributes.put(key,value.toString)
  ...
  /**
    ...
    *                                 this method.
    */
  override def removeAttribute(key: String): AnyRef = attributes.remove(key)

  override def validate(): Unit = isValid
