...
/**
  ...
  * @since 1.0
  */
class SessionContext(var host:String,var sessionId:Serializable,val context:util.Map[String,AnyRef]){

   def this() = this(null,null,new util.HashMap[String,AnyRef]())

   def this(context:util.Map[String,AnyRef]) = this(null,null,context)
  /**
  ...
  def getSessionId: Serializable = sessionId
