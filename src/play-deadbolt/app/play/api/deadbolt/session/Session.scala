...
trait Session extends java.io.Serializable{
  ...
  /**
    ...
    */
  @throws[InvalidSessionException]
  def setTimeout(maxIdleTimeInMillis: Long): Unit
  ...
  /**
    ...
    */
  @throws[InvalidSessionException]
  def getAttributeKeys: util.Collection[String]
  ...
  /**
    ...
    */
  @throws[InvalidSessionException]
  def setAttribute(key: String, value: AnyRef): Unit
  ...
  /**
    ...
    */
  @throws[InvalidSessionException]
  def removeAttribute(key: String): AnyRef
