...
trait PasswordService {
  /**
    ...
    */
    ...
    def encryptPassword(plaintextPassword: AnyRef): String

    @throws[IllegalArgumentException]
    def decryptPassword(encrypted: String): String
  ...
  /**
    ...
    */
    @throws[IllegalArgumentException]
    def passwordsMatch(submittedPlaintext: AnyRef, encrypted: String): Boolean
}