...
/**
  ...
  * @since 0.1
  */
trait AuthenticationToken extends Serializable {

  /**
    * username
    * @return
    */
  def getPrincipal: AnyRef

  /**
    * password
    * @return
    */
  def getCredentials: AnyRef
}

class UsernamePasswordToken(val username:String,val password:String) extends AuthenticationToken{
  override def getPrincipal = username
  override def getCredentials = password
}

trait AuthenticationInfo extends Serializable {
  def id:AnyRef
  /**
    * username
    * @return
...
class SimpleAuthenticationInfo(val idStr:String,val username:String,val password:String) extends AuthenticationInfo {
  override def id:AnyRef = idStr
  ...
  /**
    ...
    * @return
    */
  override def getPrincipal:AnyRef = username
  ...
  /**
    ...
    * @return
    */
  override def getCredentials:AnyRef = password
}
